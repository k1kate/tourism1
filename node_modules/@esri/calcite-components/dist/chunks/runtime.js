...
const version = "3.2.0";
const buildDate = "2025-05-14";
const revision = "4f2d7eb58";
...
globalScript();
const runtime = makeRuntime({ defaultAssetPath: "https://js.arcgis.com/calcite-components/3.2.0/", hydratedAttribute: "calcite-hydrated" });
